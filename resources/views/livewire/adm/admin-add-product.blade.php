            ...
            <form wire:submit.prevent="store">
                <div class="row" style="margin-bottom:20px;">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <input type="text" placeholder="Peso"  wire:model="weight">
                        @error('weight') <p class="txt-danger">{{ $message }} </p> @enderror
                    </div>

                    <div class="col-lg-6 col-md-6">
                        <p>Imagen principal<span></span></p>
                        <input class="input-file" type="file" wire:model="image">
                        @error('image') <p class="txt-danger">{{ $message }} </p> @enderror
                        @if($image)
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <input class="input-file" type="file" wire:model="images" multiple>
                        @error('images') <p class="txt-danger">{{ $message }} </p> @enderror
                        @if($images)
                    ...
                    <div class="col-lg-12 text-center">
                        <button type="submit" class="site-btn">CREAR PRODUCTO</button>
                    </div>
                </div>
            </form>
        </dvi>
